...
(async () => {
	...
	console.log(`Started processing ${timezoneIds.length} timezones.`);
	console.log('');
	...
	for (const [ i, tzId ] of timezoneIds.entries()) {
		...
		await save();
		console.log(`Done processing timezone ${i + 1}/${timezoneIds.length}: ${tzId} (${city}).`);
	}
