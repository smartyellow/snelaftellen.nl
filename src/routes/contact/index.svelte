...
<p>
	Heb je suggesties voor SnelAftellen.nl?
	Werkt iets niet goed?
	Of heb je andere opmerkingen?
	Laat het ons weten via dit contactformulier.
	Dank je wel!
</p>

<form name="contact" method="post" netlify action="/contact/dankje/">
	<div class="group">
