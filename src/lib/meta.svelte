<script>
	...
	export let image = '/s/img/social/preview-default.png';
...
<svelte:head>
	...
	<meta property="og:url" content="https://www.snelaftellen.nl{path}">
	...
	<meta property="twitter:url" content="https://www.snelaftellen.nl{path}">
